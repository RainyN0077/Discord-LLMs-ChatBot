...
export default {
  ...
  promptStudio: {
    ...
    description: "Centrally manage all bot behavior configurations, from global directives to scenario-specific responses.",
    tabs: {
      global: "Global Templates",
      scopes: "Scope Overrides",
      plugins: "Plugin Integration",
      roles: "Role Strategies"
    },
    nav: {
      messageContext: "Message & Context",
      knowledgeInjection: "Knowledge & Tool Injection",
      systemPromptStructure: "System Prompt Structure",
      coreInstructions: "Core Instructions",
      messageFormat: "Message Format",
      imageNote: "Image Note",
      replyContext: "Reply Context",
      deletedReplyContext: "Deleted Reply Context",
      userRequestBlock: "User Request Block",
      toolContext: "Tool Output",
      memoryContext: "Long-term Memory",
      worldbookContext: "World Setting",
      foundationHeader: "Foundation Rules Header",
      personaHeader: "Current Persona Header",
      situationHeader: "Situation Context Header",
      participantsHeader: "Participant Portraits Header",
      securityHeader: "Security & Operation Header",
      operationalInstructions: "Operational Instructions"
    },
    editor: {
      coreInstructions: "Core Instructions",
      coreInstructionsDesc: "These are the core rules guiding bot behavior, injected into the system prompt in order.",
    ...
    simulator: {
      ...
      userRoles: "User Roles (Ctrl+click to multi-select)",
      imageCount: "Image Count",
      isReply: "Is Reply",
      replyContent: "Reply Content",
      manualRefresh: "Manual Refresh",
      generating: "Generating...",
      backendPreview: "Backend Live Preview",
      loading: "(Loading...)",
    ...
    preset: {
      ...
      import: "Import",
      delete: "Delete",
      loadFailed: "Failed to load preset: {error}",
      loading: "Loading preset: {name}...",
      loadSuccess: "Preset \"{name}\" loaded successfully.",
      savePrompt: "Enter a name for the new preset:",
      saving: "Saving preset: {name}...",
      saveSuccess: "Preset \"{name}\" saved successfully.",
      saveFailed: "Failed to save preset: {error}",
      deleteConfirm: "Are you sure you want to delete preset \"{name}\"? This cannot be undone.",
      deleting: "Deleting preset: {name}...",
      deleteSuccess: "Preset \"{name}\" deleted.",
      deleteFailed: "Failed to delete preset: {error}",
      importFailed: "Import failed: {error}",
      importSuccess: "File \"{name}\" imported successfully. You can click \"Save As...\" to persist it.",
      invalidFormat: "Invalid preset file format. Missing required fields: {keys}",
      defaultPresetLocked: "Cannot save the default preset under its own name.",
      nameTooLong: "Preset name must be at most 64 characters."
    },
    save: "Save All Settings & Restart",
    saving: "Saving...",
  ...
  globalConfig: {
    ...
    intents: {
      ...
      members: "Server Members (Privileged)"
    }
  },
  llmProvider: {
    title: "LLM Provider",
  ...
  userOptions: {
    ...
    blocklist: {
      ...
      refreshGuilds: "Refresh server list",
      manualGuildPlaceholder: "Enter server ID manually...",
      resolve: "Resolve",
      diagnostics: "Diagnostics",
      diagnosticsTitle: "Bot Status Diagnostics",
      diagOnline: "Online Status",
      diagYes: "Yes",
      diagNo: "No",
      diagGuildCount: "Server Count",
      diagEnabled: "Enabled",
      diagDisabled: "Disabled",
      diagWarnings: "Warnings",
      noGuildsWarning: "Bot is not running or has not joined any servers."
    },
    guildListRefreshed: "Server list refreshed",
    diagnosticsFailed: "Failed to fetch diagnostics: {error}",
    guildResolved: "Server '{name}' found",
    guildNotFound: "Server '{id}' not found",
    guildResolveFailed: "Resolution failed: {error}"
  },
  personaHub: {
    title: "Persona Hub",
    sections: {
    ...
    syncPortraits: "Resync Portraits",
    syncingPortraits: "Syncing...",
    syncPortraitsSuccess: "User portraits were reloaded from backend.",
    syncPortraitsFailed: "Failed to resync portraits: {error}",
  ...
  debugger: {
    ...
    confirmDelete: "Confirm delete selected records?",
    deleted: "Deleted",
    ...
    showRawContext: "Show Raw Context",
    rawContext: "Raw Context",
    systemPrompt: "System Prompt",
    formattedMessages: "Formatted Messages",
    contextError: "Context reconstruction failed",
    capturesTab: "Captures",
    sanitizeTab: "Sanitize",
    captureLimit: "Limit",
    captureUsage: "Token Usage",
    captureRefresh: "Refresh",
    captureLoading: "Loading...",
    captureChannelFilter: "Filter by channel ID (optional)",
    captureEmpty: "No captured Discord trigger conversations yet.",
    captureSelectHint: "Select one record from the left list.",
  ...
  directChat: {
    ...
    debugMode: "Debug mode (simulate Discord)",
    debugHint: "Debug mode applies Discord-style input formatting and persona/system construction. Model output is shown raw.",
    debugUserId: "User ID (numeric)",
    debugChannelId: "Channel ID (numeric)",
    debugGuildId: "Server ID (optional)",
    debugRoleId: "Role Config ID (optional)",
    formattedInput: "Formatted input sent to model",
  ...
  appearance: {
    ...
    effectAurora: "Aurora Flow",
    effectSunset: "Sunset Gradient",
    effectWash: "Ink Wash",
    effectFade: "Fade In",
